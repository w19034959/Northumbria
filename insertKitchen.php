...
//database connection
	...
	while ($row = $result-> fetchObject()) {
		...
		$sql = "INSERT INTO TPKitchenRota(workWeek, MondayStart, TuesdayStart, WednesdayStart, ThursdayStart, FridayStart, SaturdayStart, SundayStart, MondayFinish, TuesdayFinish, WednesdayFinish, ThursdayFinish, FridayFinish, SaturdayFinish, SundayFinish, employee_id)
		VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		$stmt= $db->prepare($sql);
